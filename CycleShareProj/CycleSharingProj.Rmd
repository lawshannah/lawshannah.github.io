...
```{r, echo = FALSE, message = FALSE, label = "stationLocs", fig.align='center', fig.cap="Stations map", results='hide'}
...
```{r, echo = TRUE, eval = TRUE, fig.cap="Trips by Different Member Type", fig.align='center'}
trip_2 %>%
  mutate(ym = paste(year(start_date), 
                    month(start_date), sep = "/"), Season = ifelse(ym %in% c("2014/10", "2014/11"), "Fall",
                                                            ifelse(ym %in% c("2014/12", "2015/1", "2015/2"),
...
```{r, eval = TRUE, echo = FALSE, warning = FALSE, message = FALSE, fig.cap="Trip Duration by Member Type", fig.align='center'}
...
##Additional Fees
```{r, fig.align='center', fig.cap="Additional Fees by Memeber Type", warning=FALSE, message=FALSE}
...
##Member Demographics
```{r, eval=TRUE, fig.cap = "Age Demographic of Members", fig.align='center',  message = FALSE, warnings = FALSE, echo = FALSE}
